...
final class Bootstrap{
    ...
    public function handle_buy_pro_menu(){
        ...
        */
        ...
        $filter_string .= ((!in_array('wpcafe-pro/wpcafe-pro.php', apply_filters('active_plugins', get_option('active_plugins')))) ? '' : ',wpcafe-pro');
        $filter_string .= (!class_exists('\Wpcafe_Pro') ? '' : ',wpcafe-pro');

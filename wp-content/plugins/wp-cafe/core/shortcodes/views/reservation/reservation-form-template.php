...
data-reservation_status='<?php echo json_encode( $booking_status ) ?>'>
    ...
    <div class='wpc_success_message' data-start="<?php echo esc_html__("Start time","wpcafe");?>" data-end="<?php echo esc_html__("End time","wpcafe");?>" data-schedule="<?php echo esc_html__("Schedule","wpcafe");?>" data-late_booking = "<?php echo ( $wpc_late_bookings !=="" ) 
    ?  sprintf( __("You can book up until %s minutes before closing time","wpcafe") , $wpc_late_bookings  ) : "" ?>"></div>
            ...
            <div class="wpc-row">
                ...
                <div class='<?php echo esc_attr($column_lg); ?>'>
                    <div class="wpc_reservation_form">
                        ...
                        <button type='submit' class='reservation_form_submit wpc-btn'><?php echo esc_html__( $first_booking_button , 'wpcafe' ); ?></button>
                        <span id='wpc_cancel_request'><?php echo esc_html__( $cancel_button_text ,'wpcafe'); ?></span>
                    </div>
                </div>
            </div>
        </div>
